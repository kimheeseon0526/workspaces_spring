...
<%@ taglib uri ="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	 <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
	    ...
	    <c:if test="${empty b.attachs}">
	    	<c:set var="src" value="https://placehold.co/300x300?text=No+Image" />
	    </c:if>
	    ...
	    <div class="col">
	      <div class="card h-100 shadow-sm">
	        ...
	        <div class="card-body d-flex flex-column">
	          ...
	          <p class="card-text text-muted mb-1"><i class="fa-regular fa-calendar me-2"></i>${b.regdate}</p>
	          <p class="card-text text-muted mb-1"><i class="fa-solid fa-binoculars me-2"></i>${b.cnt}</p>
